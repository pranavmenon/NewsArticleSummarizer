...
/*
 * Lemmatization library obtained from http://stanfordnlp.github.io/CoreNLP/
 * 
 * Note: You may need to obtain the required jar files from the red download button in the above link
 * 
 */
public final class StanfordLemmatizer {
  ...
  public static void testStanfordLemmatizer(){
    ...
    String text = "How could you be seeing into my eyes like open doors? \n"+
        ...
        "You were bringing me to life.";
    System.out.println("INPUT:\n" + text + "\n\nOUTPUT:\n" + StanfordLemmatizer.lemmatize(text));
  }
